...
namespace MyVideoResume.Data.Migrations.MyVideoResume
{
    ...
    [Migration("20241130212829_MetaResume More Naming Updates")]
    partial class MetaResumeMoreNamingUpdates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyVideoResume.Data.Models.Resume.ResumeDocumentEntity", b =>
                {
                    ...
                    b.ToTable("ResumeFormat", t =>
                        {
                            t.HasTrigger("ResumeFormat_Trigger");
                        });
            ...
            modelBuilder.Entity("MyVideoResume.Data.Models.Resume.MetaResumeFormatEntity", b =>
                {
                    b.HasOne("MyVideoResume.ResumeAbstractions.Formats.MyVideoResumeFormat.MetaResume", "Resume")
                        .WithMany()
